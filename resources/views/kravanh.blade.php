        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="img-box text-center mb-5">
                    <img src="pic/Kh (Kravanh building).webp"
                         alt="Kravanh Restaurant"
                         style="width:100%; max-height:550px; object-fit:cover; border-radius:20px;">
                </div>

                <div class="detail-box">

                    <h3 class="mb-4">Authentic Khmer Dining Experience</h3>

                    <p>
                        Kravanh Restaurant is a popular Khmer restaurant that
