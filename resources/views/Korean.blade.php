      ...
      <div class="row mt-5">
        ...
        <div class="col-md-4 mb-4">
          ...
          <div class="card shadow-lg h-100">
            ...
            <img src="{{ asset('pic/bn.jpg') }}" class="card-img-top" style="height:250px;object-fit:cover;">
        ...
        <div class="col-md-4 mb-4">
          ...
          <div class="card shadow-lg h-100">
            ...
            <img src="{{ asset('pic/dori.webp') }}" class="card-img-top" style="height:250px;object-fit:cover;">
        ...
        <div class="col-md-4 mb-4">
          ...
          <div class="card shadow-lg h-100">
            ...
            <img src="{{ asset('pic/yk.webp') }}" class="card-img-top" style="height:250px;object-fit:cover;">
